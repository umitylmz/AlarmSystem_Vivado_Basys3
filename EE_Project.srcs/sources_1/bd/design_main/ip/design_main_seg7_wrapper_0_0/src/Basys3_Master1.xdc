...
set_property PACKAGE_PIN V2 [get_ports {i8}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i8}]
set_property PACKAGE_PIN T3 [get_ports {i9}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i9}]
set_property PACKAGE_PIN T2 [get_ports {i10}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i10}]
set_property PACKAGE_PIN R3 [get_ports {i11}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i11}]
